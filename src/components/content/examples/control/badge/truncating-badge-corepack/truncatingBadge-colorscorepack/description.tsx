...
<div>
  ...
  <b>NOTE</b>: Badges are supported in
  <a href="globalSupport-FAQ.html#redwood" target="_blank">the Redwood theme</a>, they are not supported in the Alta themes.
</div>`;

export const truncatingBadgeColorscorepackDescription = (
