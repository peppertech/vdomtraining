...
export const FilmStripVerticalFilmStripNavArrows = () => {
  ...
  return (
    <div id="filmstrip-verticalnavarrows-example">
      ...
      <div id="filmStripDiv" class="demo-inline-block oj-panel oj-sm-margin-4x">
        <div class="demo-inline-block">
          <oj-film-strip
            id="filmStrip"
            class="demo-filmstrip-height"
...
export default FilmStripVerticalFilmStripNavArrows;
