...
export const filmStripFilmStripNavDotsRecipe = (
  <>
    <ol>
      <li>
        This demo uses the
      ...
      <li>
        Specify a JET oj-paging-control adjacent to the oj-film-strip that can be used to change pages
        on the FilmStrip. Set the
