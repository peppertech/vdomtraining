...
const recipeHtmlText = String.raw`<ol>
    ...
    <li><b>Accessibility</b>: If any associated information is already available to assistive technologies, for example by rendering the name in addition to the avatar as part of the page content, then setting the aria-label is optional. Otherwise setting the aria-label is required by passing a descriptive text to the <a href="jsdocs/oj-c.Avatar.html#a11y-section">aria-label</a> attribute.</li>
</ol>`;

export const avatarOverviewcorepackRecipe = (
