...
const descriptionHtmlText = String.raw`<p>Message Banners are brief, moderately disruptive, semi-permanent messages that help communicate relevant and useful information.</p><p>
  ...
  rendered in a page layout. For this layout,
  <code class="prettyprint">oj-c-message-banner</code>
  usually is defined below the page header.
</p>

<p>
  Messages are rendered between the page header and the page content and will push down the page's
  content when new messages are added. The messages scroll with the page content.
</p>
...
export const messagebannerPageMessagescorepackDescription = (
