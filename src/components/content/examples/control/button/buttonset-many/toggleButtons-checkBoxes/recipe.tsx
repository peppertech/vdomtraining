...
export const toggleButtonsCheckBoxesRecipe = (
  <>
    <p>Buttonset:</p>
    <ol>
      <li>
    ...
    <ol>
      <li>
        Inside the buttonset, create each button from an
        <code className={"prettyprint"}>&lt;oj-option&gt;</code>
        .
      </li>
      <li>
        Either list the buttons individually as shown here, or stamp them out with a
        <code className={"prettyprint"}>foreach</code>
        binding on a nested virtual element, as shown in the
        <a href={"#"}>
          Buttonset One demo
        </a>
        .
