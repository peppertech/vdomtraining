...
export const rowExpanderDataGridDataGridRowExpanderRecipe = (
  <>
    <ol>
      <li>
      ...
      <li>
        Create a FlattenedTreeDataGridDataSource from the JSONTreeDataSource and options specific to the
        grid implementation.
      </li>
