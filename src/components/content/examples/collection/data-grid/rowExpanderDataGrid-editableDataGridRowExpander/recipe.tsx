...
export const rowExpanderDataGridEditableDataGridRowExpanderRecipe = (
  <>
    <ol>
      <li>
      ...
      <li>
        For editing, specify the edit-mode attribute, a function to choose between cell templates, and a
        beforeEditEnd listener to perform validation.
      </li>
      ...
      <li>Apply bindings to the data grid with the data and necessary functions in the binding.</li>
    </ol>
  </>
);
