...
const recipeHtmlText = String.raw`<ol>
  ...
  <li>
    ...
    <code class="prettyprint">oj-c-list-item-layout</code>, whose attributes are bound to properties of the template context, as appropriate.
  </li>
  <li>
    You can use
...
export const listItemLayoutTablecorepackRecipe = (
