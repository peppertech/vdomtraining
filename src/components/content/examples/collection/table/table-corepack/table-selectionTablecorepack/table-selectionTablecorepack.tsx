...
import { KeySet, KeySetImpl, AllKeySetImpl } from 'ojs/ojkeyset';
...
type TableSelectedItems = {
    row?: KeySet<Employee['DepartmentId']>;
...
export const TableSelectionTablecorepack = () => {
...
export default TableSelectionTablecorepack;
