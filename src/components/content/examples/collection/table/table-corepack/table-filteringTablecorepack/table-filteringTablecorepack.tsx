...
export const TableFilteringTablecorepack = () => {
  ...
  useEffect(() => {
    ...
    const subscriber = observable.subscribe((value: { type: string; count?: number }) => {
      if (value.type === 'exact' && typeof value.count === 'number') {
...
export default TableFilteringTablecorepack;
