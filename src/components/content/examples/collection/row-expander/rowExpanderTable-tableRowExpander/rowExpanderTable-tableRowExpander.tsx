...
export const RowExpanderTableTableRowExpander = () => {
  ...
  return (
      <div id="tableWrapper">
            <oj-table id="table" aria-label="Tasks Table" data={dataProvider} selectionMode={{ row: 'multiple' }} layout="fixed" columns={columns} class="oj-sm-width-full" {...ojTableProps}>
...
export default RowExpanderTableTableRowExpander;
