...
export const treeViewDndRecipe = (
  <>
    <ol>
      <li>
        Allow drag and drop between TreeViews by specifying the same dataTypes in the drag and the drop
        options.
      </li>
      <li>
        Create two nested observable array structures (called
        {" "}
        <code>observableArrayTree</code>
        {" "}
        respectively in this demo) using data from a local JSON
      </li>
      <li>
