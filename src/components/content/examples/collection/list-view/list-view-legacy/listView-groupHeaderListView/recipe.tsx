...
export const listViewGroupHeaderListViewRecipe = (
  <>
    <ol>
      ...
      <li>
        Specify the oj-group-header-sm, oj-group-header-md, oj-group-header-lg style class to specify
        what size of group header to show.
      </li>
    </ol>
  </>
);
