...
export default function RichCheckBoxsetCorePackMinimumExample() {
    ...
    <div id="form-container">
      <oj-c-form-layout direction="row" fullWidth>
        <oj-c-rich-checkboxset
          ...
          labelHint="Minimum Selection, (min-selected=2)"
          labelEdge="top"
          help={{ instruction: "Select at least 2 employees." }}
          minSelected={2}
        ...
        <oj-c-rich-checkboxset
          ...
          value={requiredValue}
          options={avatarOptions}
          labelHint="Required With Minimum Selection, (min-selected=2)"
          labelEdge="top"
          help={{ instruction: "Select at least 2 employees." }}
          minSelected={2}
          required={true}
