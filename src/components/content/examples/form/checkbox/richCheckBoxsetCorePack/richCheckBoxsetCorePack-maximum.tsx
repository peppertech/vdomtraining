...
export default function RichCheckBoxsetCorePackMaximumExample() {
    ...
    <div id="form-container">
      <oj-c-form-layout direction="row" fullWidth>
        <oj-c-rich-checkboxset
          ...
          labelHint="Maximum Selection, (max-selected=3)"
          labelEdge="top"
          help={{ instruction: "Select up to 3 employees." }}
          maxSelected={3}
        ...
        <oj-c-rich-checkboxset
          ...
          value={requiredValue}
          options={avatarOptions}
          labelHint="Required With Maximum Selection, (max-selected=3)"
          labelEdge="top"
          help={{ instruction: "Select up to 3 employees." }}
          maxSelected={3}
          required={true}
