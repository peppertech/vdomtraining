...
import {
  ...
  type InputDateMaskValueChangedEvent,
} from "./inputDateMask-shared";

export default function InputDateMaskSimpleExample() {
  ...
  const handleRawValueChanged = useCallback(
    (event: InputDateMaskRawValueChangedEvent) => {
