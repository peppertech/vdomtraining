...
export const treemapContextMenuRecipe = (
  <>
    <ul>
      <li>
        To trigger a context menu on treemap nodes, create an oj-menu element as a child of the
        oj-treemap element.
      </li>
      ...
      <li>
        ...
        <a target={"_blank"} href={"jsdocs/oj.ojTreemap.html#getContextByNode"}>API doc</a>
        .
      </li>
      <li>
