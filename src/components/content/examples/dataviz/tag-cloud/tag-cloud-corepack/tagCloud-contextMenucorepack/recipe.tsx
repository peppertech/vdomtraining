...
const recipeHtmlText = String.raw`<ul>
  ...
  <li>
    ...
    <a href="jsdocs/oj-c.TagCloud.html#event:ojContextMenuAction">
      <i><b>on-oj-context-menu-action</b></i>
    </a> and 
    <a href="jsdocs/oj-c.TagCloud.html#event:ojContextMenuSelection">
      <i><b>on-oj-context-menu-selection</b></i>
    </a> events.
  </li>
</ul>`;

export const tagCloudContextMenucorepackRecipe = (
