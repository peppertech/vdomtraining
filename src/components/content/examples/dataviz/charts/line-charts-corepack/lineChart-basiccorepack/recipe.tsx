...
const recipeHtmlText = String.raw`<ol>
  <li>
    Create an oj-c-line-chart element.
  </li>
  <li>
  ...
  <li>
    <b>Accessibility</b>
    : The
    <a target="_blank" href="jsdocs/oj-c.LineChartItem.html#shortDesc">
      <i><b>short-desc</b></i>
    </a> property in oj-c-line-chart-item
...
export const lineChartBasiccorepackRecipe = (
