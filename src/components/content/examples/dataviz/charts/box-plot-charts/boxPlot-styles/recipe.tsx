...
export const boxPlotStylesRecipe = (
  <>
    <ul>
      <li>
        For box-plot specific stylings, use the
        {" "}
        <a target={"_blank"} href={"jsdocs/oj.ojChartSeries.html#boxPlot"}>
          <b><i>box-plot</i></b>
        </a>
        {" "}
        attribute of the oj-chart-series element.
      </li>
      <li>
        For bar specific stylings like
        {" "}
        <i>barGapRatio</i>
        {" "}
        and
