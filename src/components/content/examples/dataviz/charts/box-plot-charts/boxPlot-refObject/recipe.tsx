...
export const boxPlotRefObjectRecipe = (
  <>
    <p>
      On the chart's xAxis and/or yAxis object, create a
      {" "}
      <i><b>referenceObjects</b></i>
      {" "}
      array. Apply the following steps to this object then set it on the x-axis or y-axis attribute of
      the chart.
    </p>
    <ol>
      <li>
