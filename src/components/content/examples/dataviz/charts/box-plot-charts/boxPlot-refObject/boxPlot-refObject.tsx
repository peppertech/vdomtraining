...
import * as dataText from 'text!../data/cookbook/dataVisualizations/chart/resources/boxPlotSingleSeriesData.json';
...
type ItemTemplateContext = {
  data: BoxPlotChartItem;
};

const data = JSON.parse(dataText as string) as BoxPlotChartItem[];
...
export default BoxPlotRefObject;
