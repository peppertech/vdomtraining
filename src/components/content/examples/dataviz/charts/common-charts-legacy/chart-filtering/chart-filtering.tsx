...
export const ChartFiltering = () => {
    ...
    const [hiddenCategoriesValue, setHiddenCategoriesValue] = useState<string[]>(() => [data[0].series]);
    ...
    return (<div id="chart-container">
            <oj-legend id="legend1" class="demo-filtering-legend-height" aria-controls="barChart1 bubbleChart barChart2 areaChart pieChart funnelChart" orientation="horizontal" data={legendDataProvider} halign="center" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} hideAndShowBehavior="on">
                    <template slot="itemTemplate" render={itemTemplateRenderer}/>
                </oj-legend>
            <div class="oj-sm-odd-cols-12 oj-md-odd-cols-6">
                    <div class="oj-flex">
                              <oj-chart id="barChart" class="oj-flex-item" type="bar" data={singleGroupDataProvider} animationOnDisplay="auto" animationOnDataChange="auto" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} {...OjChartProps}>
                                          <template slot="itemTemplate" render={itemTemplateRenderer2}/>
                                      </oj-chart>
                              <oj-chart id="bubbleChart" type="bubble" class="oj-flex-item" data={bubbleDataProvider} animationOnDisplay="auto" animationOnDataChange="auto" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} {...OjChartProps2}>
                                          <template slot="itemTemplate" render={itemTemplateRenderer3}/>
                                      </oj-chart>
                          </div>
                    <div class="oj-flex">
                              <oj-chart id="barChart2" type="bar" class="oj-flex-item" data={timeSeriesDataProvider} animationOnDisplay="auto" animationOnDataChange="auto" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} {...OjChartProps3}>
                                          <template slot="itemTemplate" render={itemTemplateRenderer4}/>
                                      </oj-chart>
                              <oj-chart id="areaChart" type="area" class="oj-flex-item" data={timeSeriesDataProvider} stack="on" animationOnDisplay="auto" animationOnDataChange="auto" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} {...OjChartProps4}>
                                          <template slot="itemTemplate" render={itemTemplateRenderer5}/>
                                      </oj-chart>
                          </div>
                    <div class="oj-flex">
                              <oj-chart id="pieChart" type="pie" class="oj-flex-item" data={singleGroupDataProvider} animationOnDisplay="auto" animationOnDataChange="auto" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} {...OjChartProps5}>
                                          <template slot="itemTemplate" render={itemTemplateRenderer6}/>
                                      </oj-chart>
                              <oj-chart id="funnelChart" type="funnel" class="oj-flex-item" data={singleGroupDataProvider} orientation="horizontal" animationOnDisplay="auto" animationOnDataChange="auto" onhiddenCategoriesChanged={handleHiddenCategoriesValueHiddenCategoriesChanged} hiddenCategories={hiddenCategoriesValue} {...OjChartProps6}>
