...
export const chartContextMenuRecipe = (
  <>
    <ul>
      <li>
        To trigger a context menu on chart data items, create an oj-menu element as a child of the
        oj-chart element.
      </li>
      ...
      <li>
        ...
        <a target={"_blank"} href={"jsdocs/oj.ojChart.html#getContextByNode"}>API doc</a>
        .
      </li>
      <li>
