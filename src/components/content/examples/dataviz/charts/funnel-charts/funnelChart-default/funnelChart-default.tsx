...
export const FunnelChartDefault = () => {
...
return (
      <div id="chart-container">
            ...
            <oj-toolbar id="myToolbar" aria-label="Chart Display Controls Toolbar" aria-controls="funnelChart">
...
export default FunnelChartDefault;
