...
const scatterChartItems = [
  { id: "overview", name: "Overview", description: scatterChartDefaultDescription, recipe: scatterChartDefaultRecipe, Component: ScatterChartDefault },
  ...
  { id: "hide-show", name: "Hide and Show", description: scatterChartHideShowDescription, recipe: scatterChartHideShowRecipe, Component: ScatterChartHideShow },
  ...
  { id: "zoom-scroll", name: "Zoom and Scroll", description: scatterChartZoomScrollDescription, recipe: scatterChartZoomScrollRecipe, Component: ScatterChartZoomScroll },
  { id: "animation", name: "Animation", description: scatterChartAnimationDescription, recipe: scatterChartAnimationRecipe, Component: ScatterChartAnimation },
  { id: "styling", name: "Styling", description: scatterChartStylesDescription, recipe: scatterChartStylesRecipe, Component: ScatterChartStyles },
];
