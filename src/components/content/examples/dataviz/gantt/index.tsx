...
import { GanttControls } from "./gantt-controls/gantt-controls";
import { ganttControlsDescription } from "./gantt-controls/description";
import { ganttControlsRecipe } from "./gantt-controls/recipe";
import { GanttCustomBars } from "./gantt-customBars/gantt-customBars";
import { ganttCustomBarsDescription } from "./gantt-customBars/description";
import { ganttCustomBarsRecipe } from "./gantt-customBars/recipe";
import { GanttCustomDates } from "./gantt-customDates/gantt-customDates";
import { ganttCustomDatesDescription } from "./gantt-customDates/description";
import { ganttCustomDatesRecipe } from "./gantt-customDates/recipe";
...
import { GanttProgress } from "./gantt-progress/gantt-progress";
import { ganttProgressDescription } from "./gantt-progress/description";
import { ganttProgressRecipe } from "./gantt-progress/recipe";
import { GanttRefObject } from "./gantt-refObject/gantt-refObject";
import { ganttRefObjectDescription } from "./gantt-refObject/description";
import { ganttRefObjectRecipe } from "./gantt-refObject/recipe";
...
import { GanttShapedData } from "./gantt-shapedData/gantt-shapedData";
import { ganttShapedDataDescription } from "./gantt-shapedData/description";
import { ganttShapedDataRecipe } from "./gantt-shapedData/recipe";
...
const ganttItems: RecipePageItem[] = [
  ...
  },
  {
    id: "shaped-data",
    name: "Shaped Data",
    description: ganttShapedDataDescription,
    recipe: ganttShapedDataRecipe,
    Component: GanttShapedData,
  },
  {
    id: "dependencies",
    name: "Dependencies",
  ...
  },
  {
    id: "progress",
    name: "Progress",
    description: ganttProgressDescription,
    recipe: ganttProgressRecipe,
  ...
  },
  {
    id: "controls",
    name: "Controls",
    description: ganttControlsDescription,
    recipe: ganttControlsRecipe,
    Component: GanttControls,
  },
  {
    id: "custom-dates",
    name: "Custom Dates",
    description: ganttCustomDatesDescription,
    recipe: ganttCustomDatesRecipe,
    Component: GanttCustomDates,
  },
  {
    id: "custom-scales",
    name: "Custom Scales",
  ...
  },
  {
    ...
    description: ganttRefObjectDescription,
    recipe: ganttRefObjectRecipe,
    Component: GanttRefObject,
  },
  {
    id: "custom-bars",
    name: "Custom Bars",
    description: ganttCustomBarsDescription,
    recipe: ganttCustomBarsRecipe,
    Component: GanttCustomBars,
  },
  {
