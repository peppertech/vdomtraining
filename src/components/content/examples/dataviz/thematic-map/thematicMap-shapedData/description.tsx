...
export const thematicMapShapedDataDescription = (
  <>
    <p>A thematic map is an interactive data visualization that displays data corresponding to geographic locations or regions.
      ...
      This demo shows how to create a Thematic Map with a dataProvider that contains data that has
      already been shaped for the component.
    </p>
  </>
);
