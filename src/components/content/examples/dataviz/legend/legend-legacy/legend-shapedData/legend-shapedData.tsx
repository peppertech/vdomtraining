...
export const LegendShapedData = (): JSX.Element => {
  return (
    <div id="legend-container">
      <h4>Items</h4>
      <oj-legend id="legend1" orientation="vertical" data={itemDataProvider} aria-label="Legend of fruits" />
      <h4>Sections and Items</h4>
      <oj-legend
        id="legend2"
...
export default LegendShapedData;
