...
export const sunburstShapedDataDescription = (
  <>
    ...
    Each ring segment is proportionally sized relative to the other segments at a given level.</p><p>
      This demo shows how to create a JET Sunburst with a data provider that contains data that has
      already been shaped for the sunburst.
    </p>
  </>
);
