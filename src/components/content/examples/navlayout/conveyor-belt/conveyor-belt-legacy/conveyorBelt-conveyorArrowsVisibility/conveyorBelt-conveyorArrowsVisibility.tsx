...
export const ConveyorBeltConveyorArrowsVisibility = () => {
    ...
    return (
        <div id="conveyorbelt-horizontal-example">
            ...
            <div class="oj-flex">
                <oj-conveyor-belt arrowVisibility={currentNavArrowVisibility} class="oj-lg-6 oj-md-9 oj-sm-12 oj-flex-item">
...
export default ConveyorBeltConveyorArrowsVisibility;
