...
export const ConveyorBeltVerticalConveyorBelt = () => {
  return (
      <div id="conveyorbelt-vertical-example">
            <oj-conveyor-belt class="demo-vertical-height" orientation="vertical">
...
export default ConveyorBeltVerticalConveyorBelt;
