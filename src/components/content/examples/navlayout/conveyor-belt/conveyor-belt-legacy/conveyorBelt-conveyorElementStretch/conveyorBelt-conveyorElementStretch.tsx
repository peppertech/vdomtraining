...
export const ConveyorBeltConveyorElementStretch = () => {
  return (
      <div id="conveyorElementStretch">
            <div class="oj-flex">
                    <oj-conveyor-belt class="demo-conveyor-height oj-lg-6 oj-md-9 oj-sm-12 oj-flex-item">
                              <div class="demo-full-height oj-panel oj-sm-padding-4x oj-sm-margin-1x">Hydrogen</div>
...
export default ConveyorBeltConveyorElementStretch;
