...
<p>
  Side drawers always stretch to viewport's height and the bottom one to its width.
...
<ul>
  ...
  <li>
    Note that DrawerPopup animates opening and closing. However, it is app
...
export const drawerPopupSizingcorepackDescription = (
