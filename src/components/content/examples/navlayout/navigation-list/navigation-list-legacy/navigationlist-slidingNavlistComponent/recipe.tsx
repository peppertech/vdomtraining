...
export const navigationlistSlidingNavlistComponentRecipe = (
  <>
    <ol>
      <li>
      ...
      <li>
        In your javascript read data from a JSON file and create an ArrayTreeDataProvider with the data.
      </li>
      ...
      <li>
        ...
        attribute set to
        {" "}
        <code className={"prettyprint"}>sliding</code>
      </li>
      <li>
