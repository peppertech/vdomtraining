...
import * as jsonData from 'text!../../data/cookbook/layout/navigationlist/expandedWithIcons/treeViewData.json';
import ArrayTreeDataProvider = require('ojs/ojarraytreedataprovider');

type PropertyChangedEvent<T> = CustomEvent<{ value: T }>;

export const NavigationlistExpandedWithIcons = () => {
  ...
  return (
      <div id="navlistdemo">
            ...
            <div id="navlistcontainer" class={navListContainerClass}>
                    <oj-navigation-list aria-label="Choose a navigation item" onselectionChanged={handleSelectedItemSelectionChanged} selection={selectedItem} data={dataProvider} id="navlist">
...
export default NavigationlistExpandedWithIcons;
