...
export const navigationlistBadgeRecipe = (
  <>
    <ol>
      ...
      <li>
        To add Badge/Metadata/icon to navlist item, add this style class to your span
        {" "}
        <code className={"prettyprint"}>oj-navigationlist-item-end</code>
      </li>
      <li>
