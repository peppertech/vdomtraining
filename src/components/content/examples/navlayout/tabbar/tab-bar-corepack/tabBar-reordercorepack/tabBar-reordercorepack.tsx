...
export const TabBarReordercorepack = () => {
  ...
  return (
    <div id="tabbarContainer">
      <div class="oj-panel oj-bg-neutral-30 oj-sm-margin-4x-bottom">
        <div class="oj-flex demo-header oj-sm-justify-content-flex-end oj-sm-margin-4x-bottom">
          <div class="oj-flex-item oj-sm-padding-2x-horizontal">
            ...
            <oj-radioset id="edgeRadioId" labelledBy="edgeLabelId" ariaLabelledby="edgeLabelId" onvalueChanged={(event: any) => setEdge(event.detail.value)} value={edge}>
      ...
      <oj-tab-bar id="tabbar" aria-label="Tabs using json data" onselectionChanged={(event: any) => setSelectedItem(event.detail.value)} selection={selectedItem} data={dataProvider} reorderable="enabled" edge={edge} onojReorder={handleReorder}>
        <template slot="itemTemplate" render={(item: any) => <li><a href="#">{item.data.name}</a></li>} />
      </oj-tab-bar>
...
export default TabBarReordercorepack;
