define(["require", "exports", "preact/jsx-runtime"], function (require, exports, jsx_runtime_1) {
    ...
    const Footer = ({ links = _DEFAULT_LINKS }) => {
        return ((0, jsx_runtime_1.jsxs)("footer", { class: "oj-web-applayout-footer", role: "contentinfo", children: [(0, jsx_runtime_1.jsx)("div", { class: "oj-web-applayout-footer-item oj-web-applayout-max-width", children: (0, jsx_runtime_1.jsx)("ul", { children: links.map((item) => ((0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)("a", { id: item.linkId, href: item.linkTarget, target: "_blank", children: item.name }) }))) }) }), (0, jsx_runtime_1.jsx)("div", { class: "oj-web-applayout-footer-item oj-web-applayout-max-width oj-text-secondary-color oj-text-sm", children: "Copyright \u00A9 2014, 2023 Oracle and/or its affiliates All rights reserved." })] }));
    };
