define(["require", "exports", "preact/jsx-runtime", "preact/hooks", "ojs/ojdialog", "ojs/ojpopup", "ojs/ojbutton", "preact"], function (require, exports, jsx_runtime_1, hooks_1) {
    ...
    const Dialog = () => {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { class: "oj-web-applayout-max-width oj-web-applayout-content", children: (0, jsx_runtime_1.jsxs)("div", { class: "oj-oj-typography-bold", children: [(0, jsx_runtime_1.jsx)("oj-button", { onojAction: open, label: "Open Dialog" }), (0, jsx_runtime_1.jsx)("span", { children: (0, jsx_runtime_1.jsxs)("oj-dialog", { id: "dialog1", "dialog-title": "Example Dialog", "aria-describedby": "desc", ref: diag1, children: [(0, jsx_runtime_1.jsx)("div", { slot: "body", children: (0, jsx_runtime_1.jsx)("p", { id: "desc", children: "This is the dialog content. User can change dialog resize behavior, cancel behavior and drag behavior by setting properties. Default property value depends on the theme." }) }), (0, jsx_runtime_1.jsx)("div", { slot: "footer", children: (0, jsx_runtime_1.jsx)("oj-button", { id: "okButton", onojAction: close, children: "OK" }) })] }) })] }) }));
    };
