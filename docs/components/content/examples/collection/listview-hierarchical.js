define(["require", "exports", "preact/jsx-runtime", "preact/hooks", "ojs/ojkeyset", "text!./data/peopleData.json", "ojs/ojmutablearraydataprovider", "ojs/ojbutton", "ojs/ojlistview", "ojs/ojlistitemlayout", "ojs/ojavatar", "ojs/ojtoolbar", "ojs/ojselector"], function (require, exports, jsx_runtime_1, hooks_1, ojkeyset_1, peopleData, MutableArrayDataProvider) {
    ...
    const ListView = () => {
        ...
        const handleSelectedKeyChanged = (event) => {
            setselectedItems(event.detail.value);
        };
        const renderListItem = (0, hooks_1.useCallback)((item) => {
            return ((0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsxs)("oj-list-item-layout", { children: [(0, jsx_runtime_1.jsx)("oj-selector", { "aria-label": "selector", slot: "selector", selectedKeys: selectedItems, onselectedKeysChanged: handleSelectedKeyChanged, selectionMode: "multiple", rowKey: item.data.id, id: "listview_checkboxset" + item.data.id }), (0, jsx_runtime_1.jsx)("oj-avatar", { slot: "leading", shape: "square", size: "sm", src: item.data.image }), (0, jsx_runtime_1.jsx)("div", { class: "oj-typography-body-md oj-typography-bold", children: item.data.name }), (0, jsx_runtime_1.jsx)("div", { slot: "secondary", class: "oj-typography-body-sm", children: item.data.department }), (0, jsx_runtime_1.jsx)("div", { slot: "action", children: (0, jsx_runtime_1.jsxs)("oj-toolbar", { "aria-label": "Toolbar", chroming: "borderless", children: [(0, jsx_runtime_1.jsxs)("oj-button", { id: "save" + item.data.id, display: "icons", class: "oj-button-sm", children: [(0, jsx_runtime_1.jsx)("span", { slot: "startIcon", class: "oj-ux-ico-save" }), "Save"] }), (0, jsx_runtime_1.jsxs)("oj-button", { id: "download" + item.data.id, display: "icons", class: "oj-button-sm", children: [(0, jsx_runtime_1.jsx)("span", { slot: "startIcon", class: "oj-ux-ico-download" }), "Download"] }), (0, jsx_runtime_1.jsxs)("oj-button", { id: "print" + item.data.id, display: "icons", class: "oj-button-sm", children: [(0, jsx_runtime_1.jsx)("span", { slot: "startIcon", class: "oj-ux-ico-print" }), "Print"] })] }) })] }) }));
        }, [selectedItems]);
        return ((0, jsx_runtime_1.jsx)("div", { class: "oj-md-margin-4x-horizontal", children: (0, jsx_runtime_1.jsx)("oj-list-view", { id: "listview", "aria-label": "list of employees", data: dataProvider, gridlines: gridlinesItemVisible, selectionMode: "multiple", onselectedChanged: handleSelectedChanged, selected: selectedItems, class: "listview-sizing", children: (0, jsx_runtime_1.jsx)("template", { slot: "itemTemplate", render: renderListItem }) }) }));
    };
